...
function optionRow(signal: AdaptiveEdgeSignal, leg: AdaptiveEdgeOptionLeg, index: number): AdaptiveEdgeRow {
  ...
  return {
    ...
    score: origin === 'adaptive_edge' ? signal.score : null,
    poc: origin === 'adaptive_edge' ? signal.poc : null,
    vwap: origin === 'adaptive_edge' ? signal.vwap : null,
    cvd: origin === 'adaptive_edge' ? signal.cvd : null,
    whyClosed: why,
