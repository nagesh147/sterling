...
import { stamp, sessionDayKey, shiftSessionDay, underlyingQuoteKey, formatSessionDay } from './board/boardTypes';
      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        {hiddenRecentCount > 0 ? (
          ...
          <SuperTrendSharedBoard
            ...
            isHistoricalSim={simNowMs != null && sessionDayKey(simNowMs) !== sessionDayKey(Date.now())}
