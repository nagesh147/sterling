...
export type SectionId =
  ...
  | 'engine' | 'navigator' | 'adaptiveEdge' | 'orbOptions' | 'atmPremiumImbalance' | 'smartMoneyOptions'
...
export const SECTION_IDS: SectionId[] = [
  ...
  'navigator', 'adaptiveEdge', 'orbOptions', 'atmPremiumImbalance', 'smartMoneyOptions', 'markets',
