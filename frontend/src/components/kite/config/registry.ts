...
export const FIELDS = F({
  ...
  strike_moneyness: {
    ...
    owner: 'market', applies: 'both', stage: 'discovery', rescan: true, home: 'market',
    evidence: 'scanner.py:443 picks the auto-exec leg from exactly these strikes; navigator/runtime.py:568 reads the same list.',
  },
  scan_expiries_indices: {
    ...
    owner: 'market', applies: 'both', stage: 'discovery', rescan: true, home: 'market',
    evidence: 'Passed to the scanner and to Navigator (navigator/runtime.py:569).',
  },
  scan_indices: {
    key: 'scan_indices',
    label: 'Indices',
  ...
  trail_target: {
    ...
    evidence: 'Computes the board plan that a hand-placed BUY is armed with (service.py:213), as well as the automatic one.',
  },
  exit_mode: {
    key: 'exit_mode',
    ...
    evidence: 'Frozen onto the position at arm time (protection.py:311) for manual arms too, then read by the monitor.',
  },
  exit_aligned_trail: {
  ...
  stop_mode: {
    ...
    evidence: 'service.py:217 passes it when arming a hand-placed BUY, and the automatic path passes the same value.',
  },
  protect_manual_orders: {
    ...
    evidence: 'service.py:149 and :192 — consulted only on the hand-placed order path.',
  },
  expiry_square_off_days: {
    ...
    evidence: 'service.py:783 iterates every registered position — including hand-placed ones armed by manual protection.',
  },
  time_stop_bars: {
    key: 'time_stop_bars',
    label: 'Time stop',
    ...
    owner: 'execution', applies: 'both', stage: 'exit', rescan: false, home: 'rules',
    evidence: 'service.py:812 iterates every registered position — including hand-placed ones armed by manual protection.',
  },
  risk_sizing: {
    key: 'risk_sizing',
    ...
    evidence: 'service.py:585-616, inside the automatic placement callback only.',
  },
  risk_pct: {
    key: 'risk_pct',
    ...
    owner: 'execution', applies: 'auto', stage: 'size', rescan: false, home: 'rules',
    evidence: 'service.py:589, inside the automatic placement callback only.',
  },
  max_lots: {
    key: 'max_lots',
    label: 'Maximum lots',
    ...
    owner: 'execution', applies: 'auto', stage: 'size', rescan: false, home: 'rules',
    evidence: 'service.py:616 / sizing.py:70, inside the automatic placement callback only.',
  },
  adx_min: {
    key: 'adx_min',
    label: 'Minimum ADX',
    ...
    evidence: 'service.py:511 — skips an automatic entry only. The board still shows ADX on every row.',
  },
  atr_pct_min: {
    key: 'atr_pct_min',
    ...
    owner: 'execution', applies: 'auto', stage: 'entry', rescan: false, home: 'rules',
    evidence: 'service.py:514 — skips an automatic entry only.',
  },
  block_entry_minutes_before_close: {
    ...
    owner: 'execution', applies: 'auto', stage: 'entry', rescan: false, home: 'rules',
    evidence: 'service.py:475 — gates the automatic entry only.',
  },
  max_spread_pct: {
    key: 'max_spread_pct',
    ...
    owner: 'execution', applies: 'auto', stage: 'entry', rescan: false, home: 'rules',
    evidence: 'service.py:623 — one quote call made at automatic entry.',
  },
  min_oi: {
    key: 'min_oi',
  ...
  max_daily_loss_pct: {
    ...
    evidence: 'service.py:485 — blocks new automatic entries only.',
  },
  wire_risk_infra: {
    key: 'wire_risk_infra',
    ...
    owner: 'execution', applies: 'auto', stage: 'guard', rescan: false, home: 'rules',
    evidence: 'service.py:636 — consulted during automatic sizing only.',
  },
  directional_mode: {
  ...
  target_delta: {
    ...
    owner: 'execution', applies: 'auto', stage: 'entry', rescan: false, home: 'rules',
    evidence: 'service.py:386 — consulted when the automatic path resolves a deep-ITM leg.',
  },
  itm_depth: {
    key: 'itm_depth',
    ...
    owner: 'execution', applies: 'auto', stage: 'entry', rescan: false, home: 'rules',
    evidence: 'service.py:386 — only consulted when target_delta is unset.',
  },
  futures_expiry: {
    key: 'futures_expiry',
