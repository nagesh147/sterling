 ...
 * separate strategy block here temporarily; it does not share SuperTrend's
 * draft/apply state or execution-mode controls.
 */
    ...
    <>
      ...
      <div style={{ marginTop: 18, paddingTop: 18, borderTop: `1px solid ${BORDER}` }}>
        ...
        <div style={{ marginBottom: 10, color: MUTED, fontSize: 11, lineHeight: 1.5 }}>
          Independent BUY-only directional options engine. It generates from NIFTY 50 and maps LONG → CE / SHORT → PE. It does not inherit SuperTrend settings.
        </div>
