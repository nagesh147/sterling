...
import { useEngineConfig, useResetEngineConfig, useRunScan, useSetEngineConfig } from '../../hooks/useSterlingKiteEngine';
import { BORDER, ChoiceRow, DIM, Field, MUTED, Section, Switch, TEXT } from './kiteSettingsPrimitives';
...
export function SuperTrendEnginePanel() {
  ...
  return <>
    ...
    <div style={{ marginTop:18,paddingTop:18,borderTop:`1px solid ${BORDER}` }}>
      ...
      <div style={{ marginBottom:10,color:MUTED,fontSize:11,lineHeight:1.5 }}>Independent BUY-only directional options engine. It scans the configured indices/F&amp;O stocks and maps LONG → CE / SHORT → PE. It does not inherit SuperTrend, Adaptive Edge, or Flow Navigator logic.</div>
