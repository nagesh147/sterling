...
export function NiftyOrbOptionsSettings(){
 ...
 return <>
  ...
  <Section title="EXECUTION OWNERSHIP">
   ...
   <div style={{fontSize:9,color:'var(--t-dim)',lineHeight:1.6}}>ORB never owns Paper/Live or Manual/Auto. Automatic entries consume universal Trading Mode and use the same Kite idempotency, safety and position-protection infrastructure. This strategy only submits BUY orders: CE for LONG and PE for SHORT.</div>
  </Section>
