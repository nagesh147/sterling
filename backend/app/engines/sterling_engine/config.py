...
class EngineConfig(BaseModel):
    ...
    disabled_symbols: List[str] = Field(default_factory=lambda: ["XRP"], description="Core symbols (BTC/ETH/SOL/XRP) toggled off — they stay in the list but are skipped by the scanner. XRP is off by default.")
