...
async def scan_universe(
    ...
    *,
    ...
    scan. Results are sorted strongest-first and are deterministic for equal
    scores because symbol is the final tie-breaker.
    """
    ...
    async def scan_one(item: UniverseInstrument) -> UniverseSignal | None:
        async with semaphore:
            try:
                ...
                if not bars:
                    return None
                signal = generate_signal(bars, strategy_config)
