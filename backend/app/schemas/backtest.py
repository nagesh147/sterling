...
class UnifiedBacktestRequest(BaseModel):
    ...
    stop_points: Optional[float] = Field(default=None, description="Hard stop loss distance in spot/option points")
    target_points: Optional[float] = Field(default=None, description="Profit target distance in points")
    trail_points: Optional[float] = Field(default=None, description="Trailing stop distance in points")
