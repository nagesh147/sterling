...
def test_probability_model_is_parameterized_and_reproducible():
    params = ModelParameters(
        ...
        # The adapter reads the fitted classes by name and requires exactly
        # DOWN / FLAT / UP; "up"/"down"/"neutral" are the pre-rename labels.
        # Coefficient rows keep their order, so UP still scores highest here.
