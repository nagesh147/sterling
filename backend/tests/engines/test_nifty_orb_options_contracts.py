...
def test_expiry_dte_range_is_enforced():
    cfg = StrategyConfig(expiry_selection="nearest", expiry_dte_min=0, expiry_dte_max=2)
    contracts = [
...
def test_weekly_and_monthly_selection_are_distinct():
    cfg = StrategyConfig(expiry_selection="weekly", expiry_dte_min=0, expiry_dte_max=60)
